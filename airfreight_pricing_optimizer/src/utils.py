...
def get_sample_data(n_rows: int = 5_000, seed: int = 42) -> pd.DataFrame:
    ...
    return pd.DataFrame({
        ...
        "ORIG_COUNTRY":            orig,
        "DEST_COUNTRY":            dest,
        "ORIG_SVC":                rng.choice(svcs, n_rows),
        "DEST_SVC":                rng.choice(svcs, n_rows),
        ...
        "MOVEMENT_TYPE":           rng.choice(["EXPORT", "IMPORT"], n_rows),
        "INCOTERM":                rng.choice(["DDP", "DAP", "EXW", "FOB", "CIP"], n_rows),
        "QUOTE_WGT_KG":            weight,
        "UOM":                     "KG",
        ...
        "DISCOUNT_TYPE":           rng.choice(["FLAT", "PCT", "NONE"], n_rows),
        ...
        "PAYOR_TYPE":              rng.choice(["SHIPPER", "CONSIGNEE", "THIRD_PARTY"], n_rows),
        "WON":                     won,
        "SHIPMENT_COUNT":          won,
        "REVENUE":                 revenue,
        "GRATE":                   grate,
        ...
        "CUSTOMER_CLASSIFICATION": rng.choice(["STRATEGIC", "COMMERCIAL", "SME", "SPOT"], n_rows),
    })
